...
nvm_mem_params = {
   ...
   # "max_requests_per_cycle" : 1,
    ...
    "do_not_back" : 1,
    "backend" : "memHierarchy.pagedMulti2",
    "backendConvertor.backend" : "memHierarchy.pagedMulti2",
    "backend.clock" : "1024 MHz",

    "backend.access_time" : "20ns",
        "backend.dramBackpressure" : "1",
        "backend.max_fast_pages" : 8192,
        "backend.quantum" : "10ms",
        "backend.page_shift" : "12",  #4K pages
        "backend.collect_stats" : "0",
        "backend.transfer_delay" : "0",
        "backend.threshold" : 4,
        "backend.page_add_strategy": "MRPU",
        "backend.page_replace_strategy": "LRU"
